...
from src.permutation_circuit_generator import PermutationCircuitGeneratorSparse, PermutationCircuitGeneratorSparseNaive
from src.permutation_generator import HypercubePermutator
from src.state_circuit_generator import StateCircuitGenerator, QiskitDefaultGenerator, QiskitDenseGenerator
...
def calculate_average_degree():
    ...
    iterable = list(zip(num_qubits, num_amplitudes))
...
def run_prepare_state():
    ...
    circuit_generator = QiskitDenseGenerator(permutation_generator=HypercubePermutator(), permutation_circuit_generator=PermutationCircuitGeneratorSparseNaive())
    ...
    num_clusters = [2, 4, 8, 16, 32, 64, 128]
    # num_clusters = [2]
    out_col_name = 'pairwise_swap'
    data_folder_parent = 'data_3'
    num_workers = 12
    check_fidelity = True
