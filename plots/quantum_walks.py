...
def plot_mhs_soa_comparison():
    ...
    plot_cx_count_vs_num_qubits_line_linear("mhs_nonlinear", num_qubits, num_amplitudes, 0, 0, "MHS CTQW Nonlinear", figure_id)
...
def plot_mhs_soa_comparison2():
    ...
    plot_cx_count_vs_num_qubits_line("mhs_nonlinear", num_qubits, num_amplitudes, 0, 0, "MHS CTQW Nonlinear", figure_id)
...
def plot_walks_comparison():
    ...
    figure_id = 0
    plot_cx_count_vs_num_qubits_line_linear("mhs_nonlinear", num_qubits, num_amplitudes, 0, 0, "MHS CTQW Nonlinear", figure_id)
    plot_cx_count_vs_num_qubits_line_linear("mhs_linear", num_qubits, num_amplitudes, 3, 0, "MHS CTQW Linear", figure_id)
